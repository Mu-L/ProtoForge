...
const routes = [
  ...
  { path: '/test-plans', component: () => import('./views/TestPlans.vue'), meta: { roles: ['admin', 'operator', 'user'] } },
  { path: '/compliance', component: () => import('./views/Compliance.vue'), meta: { roles: ['admin', 'operator', 'user'] } },
